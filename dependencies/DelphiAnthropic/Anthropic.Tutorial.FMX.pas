...
begin
  ...
  Display(Sender, [
    ...
    F('  � type', Value.&Type),
    F('  � name', Value.Name),
    F('  � version', Value.Version.ToString),
    F('  � model', ModelId),
    F('  � created_at', Value.CreatedAt),
    F('  � updated_at', Value.UpdatedAt)
  ]);
  Display(Sender, '');
end;
...
begin
  ...
  Display(Sender, [
    ...
    F('  � type', Value.&Type),
    F('  � name', Value.Name),
    F('  � description', Value.Description.Trim),
    F('  � created_at', Value.CreatedAt),
    F('  � updated_at', Value.UpdatedAt)
  ]);
  Display(Sender, '');
...
begin
  ...
  Display(Sender, [
    ...
    F('  � agent_id', AgentId),
    F('  � environment_id', Value.EnvironmentId),
    F('  � resources', Length(Value.Resources).ToString),
    F('  � created_at', Value.CreatedAt),
    F('  � updated_at', Value.UpdatedAt)
  ]);
  Display(Sender, '');
...
begin
  ...
  Display(Sender, [
    Value.Id,
    F('  � type', Value.&Type),
    F('  � processed_at', Value.ProcessedAt),
    F('  � name', Value.Name),
    F('  � result', Value.Result),
    F('  � tool_use_id', Value.ToolUseId),
    F('  � session_thread_id', Value.SessionThreadId)
  ]);
  Display(Sender, '');
end;
...
begin
  ...
  Display(Sender, [
    ...
    F('  � type', Value.&Type),
    F('  � name', Value.Name),
    F('  � mount_path', Value.MountPath),
    F('  � file_id', Value.FileId),
    F('  � memory_store_id', Value.MemoryStoreId),
    F('  � url', Value.Url)
  ]);
  Display(Sender, '');
end;
...
begin
  ...
  Display(Sender, [
    ...
    F('  � type', Value.&Type),
    F('  � status', Value.Status),
    F('  � session_id', Value.SessionId),
    F('  � parent_thread_id', Value.ParentThreadId),
    F('  � agent_id', AgentId),
    F('  � created_at', Value.CreatedAt),
    F('  � updated_at', Value.UpdatedAt)
  ]);
...
begin
  ...
  Display(Sender, [
    Value.Id,
    F('  � type', Value.&Type),
    F('  � display_name', Value.DisplayName),
    F('  � created_at', Value.CreatedAt),
    F('  � updated_at', Value.UpdatedAt)
  ]);
  Display(Sender, '');
...
begin
  ...
  Display(Sender, [
    ...
    F('  � vault_id', Value.VaultId),
    F('  � status', Value.Status),
    F('  � has_refresh_token', Value.HasRefreshToken),
    F('  � validated_at', Value.ValidatedAt)
  ]);
  Display(Sender, '');
end;
...
begin
  ...
  Display(Sender, [
    ...
    F('  � type', Value.&Type),
    F('  � path', Value.Path),
    F('  � store_id', Value.MemoryStoreId),
    F('  � version_id', Value.MemoryVersionId),
    F('  � size_bytes', Value.ContentSizeBytes.ToString),
    F('  � created_at', Value.CreatedAt),
    F('  � updated_at', Value.UpdatedAt)
  ]);
  Display(Sender, '');
...
begin
  ...
  Display(Sender, [
    ...
    F('  � path', Value.Path),
    F('  � memory_id', Value.MemoryId),
    F('  � store_id', Value.MemoryStoreId),
    F('  � size_bytes', SizeBytes),
    F('  � created_at', Value.CreatedAt),
    F('  � redacted_at', Value.RedactedAt)
  ]);
  Display(Sender, '');
end;
