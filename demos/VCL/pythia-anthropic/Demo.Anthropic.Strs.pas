unit Demo.Anthropic.Strs;

interface

type
  TAnthropicDemoTranslations = record
  public
...
class procedure TAnthropicDemoTranslations.Load(const Value: string);
begin
...
class procedure TAnthropicDemoTranslations.LoadFromLanguage(
